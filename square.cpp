...
square::square(const square &other) : position{other.position}, color{other.color},size_o{other.size_o}, shape{other.shape},size_v{other.size_v}, big_shape{other.big_shape} {}
